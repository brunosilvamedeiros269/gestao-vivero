'use client';
import { Truck, Package, Tag, ArrowLeft, LayoutDashboard, Settings, Flower2, Briefcase, Map as MapIcon, Wifi, ShoppingBag, ShoppingCart } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    { href: '/admin/pdv', label: t('pos'), icon: <ShoppingCart size={20} /> },
